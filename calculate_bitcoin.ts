/**
 * Calculate Bitcoin Mining Potential for 2025-04-03
 * 
 * This script calculates the Bitcoin mining potential for 2025-04-03
...
const DEFAULT_DIFFICULTY = 113757508810853; // Fallback difficulty
...
async function processBitcoinCalculations(): Promise<void> {
  ...
  try {
    ...
    try {
      ...
      log(`Error getting difficulty data, using fallback: ${DEFAULT_DIFFICULTY}`);
