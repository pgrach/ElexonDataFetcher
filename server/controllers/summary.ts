  ...
  try {
    ...
    if (!leadParty) {
      ...
      return res.json({
        ...
        totalPayment: Math.abs(Number(summary.totalPayment)), // Use absolute value
        leadParty: null
      });
    }
    ...
    res.json({
      ...
      totalPayment: Math.abs(Number(recordTotals[0].totalPayment)), // Use absolute value
      leadParty
    });
  ...
  try {
    ...
    if (leadParty) {
      ...
      return res.json({
        ...
        totalPayment: Math.abs(Number(farmTotals[0].totalPayment)), // Use absolute value
      });
    }
    ...
    res.json({
      ...
      dailyTotals: {
        ...
        totalPayment: Math.abs(Number(dailyTotals[0]?.totalPayment || 0)) // Use absolute value
      }
    });
  } catch (error) {
...
export async function getYearlySummary(req: Request, res: Response) {
  try {
    ...
    res.json({
      ...
      totalPayment: Math.abs(yearTotals.totalPayment) // Use absolute value
    });
  } catch (error) {
