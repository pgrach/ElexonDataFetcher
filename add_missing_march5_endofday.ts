...
// Focus only on the very end of the day (last few periods)
const START_PERIOD = 44;
const END_PERIOD = 48;
...
async function addMissingData() {
  try {
    console.log(`\n=== Adding Missing Curtailment Data for ${TARGET_DATE} (Periods ${START_PERIOD}-${END_PERIOD}) ===\n`);
