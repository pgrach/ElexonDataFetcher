      ...
      <CardContent>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-4">
          ...
          <div className="flex flex-col gap-3 p-4 rounded-md bg-background/95 shadow-sm border border-primary/10 relative overflow-hidden">
            <div className="bg-primary shadow-md text-primary-foreground rounded-full w-8 h-8 flex items-center justify-center absolute -top-3 -left-3 font-semibold">1</div>
          ...
          {/* Step 2 */}
          <div className="flex flex-col gap-3 p-4 rounded-md bg-background/95 shadow-sm border border-primary/10 relative overflow-hidden">
            <div className="bg-primary shadow-md text-primary-foreground rounded-full w-8 h-8 flex items-center justify-center absolute -top-3 -left-3 font-semibold">2</div>
          ...
          {/* Step 3 */}
          <div className="flex flex-col gap-3 p-4 rounded-md bg-background/95 shadow-sm border border-primary/10 relative overflow-hidden">
            <div className="bg-primary shadow-md text-primary-foreground rounded-full w-8 h-8 flex items-center justify-center absolute -top-3 -left-3 font-semibold">3</div>
