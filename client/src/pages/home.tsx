...
import { Wind, Battery, Calendar as CalendarIcon, Building, Compare } from "lucide-react";
...
export default function Home() {
  ...
  return (
    <div className="container mx-auto py-8">
      <h1 className="text-4xl font-bold mb-8">Wind Farm Curtailment Dashboard</h1>

      {/* New Top Filter Bar */}
      <div className="bg-card border rounded-lg p-4 mb-8 flex flex-wrap gap-4 items-center">
