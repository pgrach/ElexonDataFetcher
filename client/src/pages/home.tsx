...
export default function Home() {
  const [date, setDate] = useState<Date>(new Date("2024-12-01")); // Default to December 2024
          ...
          <Card>
            ...
            <CardContent>
              <Calendar
                ...
                disabled={(date) => {
                  // Allow dates from August 2024 to today
                  return date < new Date("2024-08-01") || date > new Date();
                }}
              />
            </CardContent>
          </Card>
