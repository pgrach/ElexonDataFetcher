...
import { Wind, Battery, Building } from "lucide-react";
...
export default function Home() {
  ...
  return (
    <div className="container mx-auto py-4">
      <h1 className="text-3xl font-bold mb-6">Wind Farm Curtailment Dashboard</h1>

      <FilterBar
        date={date}
        onDateChange={(newDate) => newDate && setDate(newDate)}
        selectedFarm={selectedLeadParty}
        onFarmChange={setSelectedLeadParty}
        availableFarms={curtailedLeadParties}
      />
