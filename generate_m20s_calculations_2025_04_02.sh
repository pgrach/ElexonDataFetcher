...
# Script to generate M20S Bitcoin calculations for 2025-04-02

echo "==== Starting M20S Bitcoin Calculations Generation for 2025-04-02 ===="
echo "This script will generate historical Bitcoin calculations for the M20S miner model"
echo "for 2025-04-02 and update the daily Bitcoin summary."
echo ""
...
npx tsx server/scripts/generate_m20s_bitcoin_calculations_2025_04_02.ts
