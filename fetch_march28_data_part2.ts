/**
 * Fetch March 28, 2025 Data - Part 2 (Periods 13-24)
 * 
 * This script:
 * 1. Fetches data from Elexon API for 2025-03-28 for periods 13-24
...
const START_PERIOD = 13;
const END_PERIOD = 24;
const LOG_FILE = `fetch_march28_part2.log`;
