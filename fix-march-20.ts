/**
 * Fix Bitcoin difficulty for March 20, 2025
 * 
 * This script updates the difficulty value for March 20 in historical_bitcoin_calculations
...
const DATE_TO_UPDATE = '2025-03-20';
...
async function fixMarchDifficulty() {
  ...
  try {
    ...
    console.log(`Current difficulty in database: ${currentDifficulty}`);
    ...
    if (String(currentDifficulty) === String(correctDifficulty)) {
