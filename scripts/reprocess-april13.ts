/**
 * Direct Reingestion Script for 2025-04-13
 * 
 * This script reprocesses all curtailment data from Elexon for April 13, 2025,
 ...
 * 
 * Run with: npx tsx scripts/reprocess-april13.ts
 */
