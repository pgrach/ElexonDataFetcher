/**
 * Fetch March 28, 2025 Data - Part 4 (Periods 37-48)
 * 
 * This script:
 * 1. Fetches data from Elexon API for 2025-03-28 for periods 37-48
...
const START_PERIOD = 37;
const END_PERIOD = 48;
const LOG_FILE = `fetch_march28_part4.log`;
