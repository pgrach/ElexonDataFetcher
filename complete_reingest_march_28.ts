/**
 * Complete Reingest for March 28, 2025
 * 
 * This script completely removes all settlement period data for March 28, 2025
...
async function main(): Promise<void> {
  console.log(`=== Complete Reingest for March 28, 2025 ===`);
