...
# Script to reprocess Bitcoin calculations for 2025-04-02 using direct method

echo "==== Starting Direct Bitcoin Calculation Reprocessing for 2025-04-02 ===="
...
npx tsx server/scripts/process_bitcoin_2025_04_02_direct.ts
