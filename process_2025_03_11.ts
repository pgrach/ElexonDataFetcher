/**
 * Focused Processor for 2025-03-11
 * 
 * This script provides a streamlined way to process data for 2025-03-11
...
/**
 * Get detailed statistics by period
 */
...
async function processTargetDate() {
  try {
    ...
    // Step 6: Display detailed period statistics
    ...
    console.log(`------ | ------- | ----- | ------------ | -----------`);
    console.log(`Total  | ${totalRecords.toString().padStart(7)} | ${afterState.farmCount.toString().padStart(5)} | ${
